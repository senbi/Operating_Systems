...
DEF_SYSCALL(Spawn_Program, SYS_SPAWN, int,
                (const char *program, const char *command, int background),
...
DEF_SYSCALL(Fork, SYS_FORK, int, (void),, SYSCALL_REGS_0)
   DEF_SYSCALL(Clone, SYS_CLONE, int, (void (*func) (void), void *stackPtr),
               void *arg0 = func;
               void *arg1 = stackPtr;
               , SYSCALL_REGS_2)
DEF_SYSCALL(Execl, SYS_EXECL, int, (const char *program, const char *command),
            const char *arg0 = program;
...
DEF_SYSCALL(Set_Affinity, SYS_SET_AFFINITY, int, (int pid, int aff),
            ...
            int arg1 = aff;
            , SYSCALL_REGS_2)
DEF_SYSCALL(Get_Affinity, SYS_GET_AFFINITY, int, (int pid), int arg0 = pid;
            , SYSCALL_REGS_1)
#define CMDLEN 79
